...
cantidadTotal=acumuladoCriptoMoneda*cotizacionCriptoMoneda
print("El total de Dólares que tienes con la Cripto Moneda ",nombreCriptoMoneda,"es de: ",str(cantidadTotal))
