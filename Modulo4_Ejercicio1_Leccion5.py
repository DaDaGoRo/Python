...
while not valida_cripto(Cripto1):
    Cripto1= str(input("Moneda inválida, por favor ingrese un nombre válido para la Cripto Moneda 1: "))
...
while not valida_cripto(Cripto2):
    Cripto2= str(input("Moneda inválida, por favor ingrese un nombre válido para la Cripto Moneda 2: "))
print("Verificando la Cripto Moneda ingresada...")
...
while not valida_cripto(Cripto3):
    Cripto3= str(input("Moneda inválida, por favor ingrese un nombre válido para la Cripto Moneda 3: "))
print("Verificando la Cripto Moneda ingresada...")
